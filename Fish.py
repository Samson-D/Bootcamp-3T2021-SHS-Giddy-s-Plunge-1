...
wn.register_shape('fishleft.gif')
wn.register_shape('fishright.gif')
wn.register_shape('BOTTLE.gif')
wn.register_shape('algae.gif')
...
for _ in range(5):
    ...
    bad_thing.speed(0)
    bad_thing.shape('BOTTLE.gif')
    bad_thing.color("red")
    bad_thing.penup()
    bad_thing.goto(150, 250)
...
while True:
    ...
    for good_thing in good_things:
        ...
        if good_thing.ycor() < -280:
            good_thing.goto(random.randint(-280, 400), random.randint(280, 280))
    ...
    for bad_thing in bad_things:
        ...
        if bad_thing.ycor() < -300:
            bad_thing.goto(random.randint(-500, 400), random.randint(400, 800))
